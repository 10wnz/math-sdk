...
class OptimizationSetup:
    ...
    def __init__(self, game_config):
        ...
        WINCAP = self.game_config.wincap
        self.game_config.opt_params = {
            "base": {
                "conditions": {
                    "wincap": ConstructConditions(rtp=0.0025, av_win=WINCAP, search_conditions=2500).return_dict(),
                    "0": ConstructConditions(rtp=0, av_win=0, search_conditions=0).return_dict(),
                    "freegame": ConstructConditions(
                        rtp=0.38, hr=120, search_conditions={"symbol": "scatter"}
                    ).return_dict(),
                    "basegame": ConstructConditions(rtp=RTP - 0.0025 - 0.38, hr=2.2).return_dict(),
                },
            ...
            "bonus": {
                "conditions": {
                    "wincap": ConstructConditions(rtp=0.0025, av_win=WINCAP, search_conditions=2500).return_dict(),
                    "freegame": ConstructConditions(rtp=RTP - 0.0025, hr="x").return_dict(),
                },
                "scaling": ConstructScaling(
                    [
